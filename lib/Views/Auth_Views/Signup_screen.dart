        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text1w(text: 'Getting Started.!', fontsize: 22, color: Appcolors.subtextcolor,fontWeight: FontWeight.w600,),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 25),
              child: Text1w(text: 'Create an Account for your all Courses', fontsize: 13, color: Appcolors.subtextcolor,fontWeight: FontWeight.w500,),
            ),
            SizedBox(height: 40,),
            Align(
                alignment: Alignment.center,
            ...
            Padding(
              ...
              child: Row(
                ...
                Obx(()=> Checkbox(value:maincontroller.isChecked.value , onChanged: (value){
                  ...
                  Text2w(text: 'Agree to Terms & Conditions', fontsize: 12, color: Appcolors.blackcolor,fontWeight: FontWeight.w800,)
                ],
              ),
            ),
            SizedBox(height: 30,),
            Align(
                alignment: Alignment.center,
                child: Mainbutton(text: 'Sign Up',textPadding: EdgeInsets.only(left:110),)),
            SizedBox(height: 20,),
            Align(
                alignment: Alignment.center,
